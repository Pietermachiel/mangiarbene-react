...
class Home extends Component {
    ...
    return (    
        <div className='home'>
            ...
            {recipes
                .filter((recipe, id) => id === recipeRandom )
                .map(recipe => {
                const recipeBook = recipe.book.map(r => r.title);
                const urlBook = slugify(recipeBook);
                return (
            ...
            {/* endpoints */}
            <p className="pl-2em">api endpoints</p>
            <div className="home-endpoints">
                <a href="https://trim-seahorse.cloudvent.net/api/books.json" target="_blank" rel="noopener noreferrer">/api/books.json</a>
                <br/><br/>
                <a href="https://trim-seahorse.cloudvent.net/api/recipes.json" target="_blank" rel="noopener noreferrer">/api/recipes.json</a>
                <br/><br/>
                <a href="https://trim-seahorse.cloudvent.net/api/blog.json" target="_blank" rel="noopener noreferrer">/api/blog.json</a>                
            </div>
